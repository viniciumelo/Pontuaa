        ...
        <div class="col-12">
            <table class="c-table">
                ...
                Categorias
                    ...
                    <a class="c-btn c-btn--info pull-right" href="/admin/categoria/cadastrar">
                ...
                @forelse($lista as $c)
                    <tr class="c-table__row">                        
                        ...
                        <td class="c-table__cell">
                            ...
                            <a class="c-btn c-btn--primary" href="/admin/subcategorias/{{ $c->id }}">
                                Subcategorias
                            </a>
                        </td>                                    
                    </tr>  
...
function REMOVER(id, nome){
    swal({
        ...
        html: "Você realmente deseja remover a categoria <br> "+nome+"?",   
        type: "warning",        
